...
namespace server.Migrations
{
    ...
    [Migration("20251230021100_AddLogisticsAssignments")]
    partial class AddLogisticsAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsTaskAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LogisticsTaskId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LogisticsTaskAssignments");
                });
            ...
            modelBuilder.Entity("LogisticsTaskAssignment", b =>
                {
                    b.HasOne("LogisticsTask", "LogisticsTask")
                        .WithMany("CrewAssignments")
                        .HasForeignKey("LogisticsTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
