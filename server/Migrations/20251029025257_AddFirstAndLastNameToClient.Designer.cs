...
namespace server.Migrations
{
    ...
    [Migration("20251029025257_AddFirstAndLastNameToClient")]
    partial class AddFirstAndLastNameToClient
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientProfile", b =>
                {
                    b.HasOne("Address", "Address")
                        .WithOne("Profile")
                        .HasForeignKey("ClientProfile", "AddressId")
                    ...
                    b.HasOne("Contact", "Contact")
                        .WithOne("Profile")
                        .HasForeignKey("ClientProfile", "ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
