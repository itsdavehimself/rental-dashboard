...
namespace server.Migrations
{
    ...
    [Migration("20251029022633_RefactorClientProfileRelations")]
    partial class RefactorClientProfileRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClientProfile", b =>
                {
                    ...
                    b.HasOne("Address", null)
                        .WithOne("Profile")
                        .HasForeignKey("ClientProfile", "AddressId1");
                    ...
                    b.HasOne("Contact", null)
                        .WithOne("Profile")
                        .HasForeignKey("ClientProfile", "ContactId1");
